...
async def get_flow_5_5_today():
    ...
    data, sorted_columns = fetch_flow_today("5.5")
...
async def get_flow_6_5_today():
    # รับค่า 2 อย่างคือ ข้อมูลที่เรียงแล้ว และ รายชื่อหัวตารางที่เรียงแล้ว
    data, sorted_columns = fetch_flow_today("6.5")
...
async def get_flow_7_today():
    # รับค่า 2 อย่างคือ ข้อมูลที่เรียงแล้ว และ รายชื่อหัวตารางที่เรียงแล้ว
    data, sorted_columns = fetch_flow_today("7")
...
async def get_flow_5_5_week():
    # รับค่า 2 อย่างคือ ข้อมูลที่เรียงแล้ว และ รายชื่อหัวตารางที่เรียงแล้ว
    data, sorted_columns = fetch_flow_weekly("5.5")
...
async def get_flow_6_5_week():
    # รับค่า 2 อย่างคือ ข้อมูลที่เรียงแล้ว และ รายชื่อหัวตารางที่เรียงแล้ว
    data, sorted_columns = fetch_flow_weekly("6.5")
...
async def get_flow_7_week():
    # รับค่า 2 อย่างคือ ข้อมูลที่เรียงแล้ว และ รายชื่อหัวตารางที่เรียงแล้ว
    data, sorted_columns = fetch_flow_weekly("7")
...
async def get_flow_monthly_data_5_5():
    data, cols = fetch_flow_monthly("5.5")
    return {
        "status": "success",
...
async def get_flow_monthly_data_6_5():
    data, cols = fetch_flow_monthly("6.5")
    return {
        "status": "success",
        "month": datetime.now().strftime("%B %Y"),
        "count": len(data),
...
async def get_flow_monthly_data_7():
    data, cols = fetch_flow_monthly("7")
    return {
        "status": "success",
        "month": datetime.now().strftime("%B %Y"),
        "count": len(data),
